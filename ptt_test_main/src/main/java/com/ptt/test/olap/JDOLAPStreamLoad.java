...
/**
 * This class is a java demo for JDOLAP stream load
 *
 ...
 * How to use:
 *
 * 1 create a table in JDOLAP with any mysql client
 *
 ...
 *
 *
 * 2 change the JDOLAP cluster, db, user config in this class
 *
 ...
 */
public class JDOLAPStreamLoad {
    private final static String JDOLAP_HOST = "xxx.com";
    private final static String JDOLAP_DB = "test";
    private final static String JDOLAP_TABLE = "stream_test";
    private final static String JDOLAP_USER = "root";
    private final static String JDOLAP_PASSWORD = "xxx";
    private final static int JDOLAP_HTTP_PORT = 8410;
    ...
    private void sendData(String content) throws Exception {
        ...
        try (CloseableHttpClient client = httpClientBuilder.build()) {
            ...
            put.setHeader(HttpHeaders.AUTHORIZATION, basicAuthHeader(JDOLAP_USER, JDOLAP_PASSWORD));
            ...
            try (CloseableHttpResponse response = client.execute(put)) {
                ...
                // statusCode 200 just indicates that JDOLAP be service is ok, not stream load
    ...
    public static void main(String[] args) throws Exception {
        ...
        JDOLAPStreamLoad JDOLAPStreamLoad = new JDOLAPStreamLoad();
        JDOLAPStreamLoad.sendData(loadData);
    }
}